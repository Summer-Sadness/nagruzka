...
use Yii;
use frontend\models\Prepodavatel;
use frontend\models\PrepodavatelSearch;
...
class PrepodavatelController extends Controller
{
    ...
    {    
        $searchModel = new PrepodavatelSearch();
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    'forceReload'=>'true',
                    'title'=> "Create new Prepodavatel",
                    'content'=>'<span class="text-success">Create Prepodavatel success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    /**
     * Delete an existing Prepodavatel model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing Prepodavatel model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    {        
        ...
        foreach (Prepodavatel::findAll(json_decode($pks)) as $model) {
            $model->delete();
        }
