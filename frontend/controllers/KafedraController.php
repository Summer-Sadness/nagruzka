...
use Yii;
use frontend\models\Kafedra;
use frontend\models\KafedraSearch;
...
class KafedraController extends Controller
{
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    'forceReload'=>'true',
                    'title'=> "Create new Kafedra",
                    'content'=>'<span class="text-success">Create Kafedra success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    /**
     * Delete an existing Kafedra model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing Kafedra model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    {        
        ...
        foreach (Kafedra::findAll(json_decode($pks)) as $model) {
            $model->delete();
        }
